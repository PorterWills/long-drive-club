...
function seedSettingsTab(ss) {
  ...
  sheet.getRange(2, 1, 7, 2).setValues([
    ...
    ['event_date', ''] // TBC; set it here once the drive has a date,
    ['places_target', 20],
    ['ig_show', 'yes'],
    ['ig_followers', 21],
    ['ig_change', ''],
...
var IG_CALENDAR_SEED = [
  ['2026-07-13', 'Reel', 'Announcement', 'Public announcement. PR exclusive same day',
   ...
   'Claude Design vertical video, 20s, strongest existing stills plus the 2 LDC graphics. Overlays: September 2026 / 60 miles, then 18 holes / 20 places. Strongest collision image in the first 2 seconds, never a logo card.',
   'Vindication', 'this exists now',
   'Applications are open for the first drive. September 2026. 60 miles, then 18 holes. 20 places.',
  ...
  ['2026-07-20', 'Image', 'Mechanism', 'Close week',
   ...
   'A committee reads every application. 20 places.\nFirst drive September 2026. 60 miles, then 18 holes. Link in bio.\n\n#longdriveclub #carsandgolf #golf',
  ...
  ['2026-07-21', 'Image', 'Utility', 'Applications close',
   ...
   'The road. Breakfast. 18 holes. Lunch. The photograph.\nFirst drive September 2026. 20 places. Link in bio.\n\n#longdriveclub #carsandgolf #golf #drivingclub',
